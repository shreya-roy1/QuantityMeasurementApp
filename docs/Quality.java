 ...
 * Refactored under UC13 to enforce DRY using a centralized arithmetic helper.
 *
...
public class Quantity<U extends Enum<U> & IMeasurable<U>> {
    ...
    // =========================================================================
    // UC13 STEP 1: Arithmetic Operation Enum (Lambda & Abstract Interface options)
    // =========================================================================
    ...
    // =========================================================================
    // UC13 STEP 2 & 3: Centralized Helpers
    // =========================================================================
    ...
    // =========================================================================
    // UC13 STEP 4: Public Refactored Arithmetic Methods
    // =========================================================================
